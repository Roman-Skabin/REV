...
union REV_INTRIN_TYPE v2 final
{
    ...
    {
        return v2((value.x - start.x) / (end.x - start.x),
                  (value.y - start.y) / (end.y - start.y));
    }

    static REV_INLINE v2 REV_VECTORCALL invlerp_n(v2 start, v2 end, v2 value) // ret = [-1, 1]
    {
        return v2(((value.x - start.x) / (end.x - start.x) - 0.5f) * 2.0f,
                  ((value.y - start.y) / (end.y - start.y) - 0.5f) * 2.0f);
    }

    static REV_INLINE v2 REV_VECTORCALL clamp(v2 val, v2 min, v2 max)
    {
        return v2(RTTI::max(min.x, RTTI::min(max.x, val.x)),
                  RTTI::max(min.y, RTTI::min(max.y, val.y)));
    }
...
union REV_INTRIN_TYPE v2s final
{
    ...
    {
        return v2s(RTTI::max(min.x, RTTI::min(max.x, val.x)),
                   RTTI::max(min.y, RTTI::min(max.y, val.y)));
    }
...
union REV_INTRIN_TYPE v2u final
{
    ...
    {
        return v2u(RTTI::max(min.x, RTTI::min(max.x, val.x)),
                   RTTI::max(min.y, RTTI::min(max.y, val.y)));
    }
...
union REV_INTRIN_TYPE v3s final
{
    ...
    {
        __m128i m = _mm_mul_epi32(load(), r.load());
    ...
    REV_INLINE v3s& REV_VECTORCALL operator*=(v3s r) { store(_mm_mul_epi32(load(), r.load())); return *this; }
    ...
    REV_INLINE v3s& REV_VECTORCALL operator*=(s32 r) { store(_mm_mul_epi32(load(), _mm_set1_epi32(r))); return *this; }
...
REV_INLINE v3s REV_VECTORCALL operator*(v3s l, v3s r) { return v3s(_mm_mul_epi32(l.load(), r.load())); }
...
REV_INLINE v3s REV_VECTORCALL operator*(v3s l, s32 r) { return v3s(_mm_mul_epi32(l.load(), _mm_set1_epi32(r))); }
...
REV_INLINE v3s REV_VECTORCALL operator*(s32 l, v3s r) { return v3s(_mm_mul_epi32(_mm_set1_epi32(l), r.load())); }
...
union REV_INTRIN_TYPE v3u final
{
    ...
    {
        return v3u(_mm_max_epi32(min.load(), _mm_min_epi32(max.load(), val.load())));
    }
    ...
    REV_INLINE __m128i REV_VECTORCALL load() const
    {
        ...
        return _mm_maskload_epi32(cast<const int *>(e), _mm_setr_epi32(REV_U32_MAX, REV_U32_MAX, REV_U32_MAX, 0));
    #else
        return _mm_setr_ps(s.x, s.y, s.z, 0.0f);
    #endif
    }
    ...
    REV_INLINE v3u& REV_VECTORCALL operator*=(v3u r) { store(_mm_mul_epi32(load(), r.load())); return *this; }
    REV_INLINE v3u& REV_VECTORCALL operator/=(v3u r) { store(_mm_div_epi32(load(), r.load())); return *this; }
    ...
    REV_INLINE v3u& REV_VECTORCALL operator*=(u32 r) { store(_mm_mul_epi32(load(), _mm_set1_epi32(r))); return *this; }
    REV_INLINE v3u& REV_VECTORCALL operator/=(u32 r) { store(_mm_div_epi32(load(), _mm_set1_epi32(r))); return *this; }
...
REV_INLINE v3u REV_VECTORCALL operator*(v3u l, v3u r) { return v3u(_mm_mul_epi32(l.load(), r.load())); }
REV_INLINE v3u REV_VECTORCALL operator/(v3u l, v3u r) { return v3u(_mm_div_epi32(l.load(), r.load())); }
...
REV_INLINE v3u REV_VECTORCALL operator*(v3u l, u32 r) { return v3u(_mm_mul_epi32(l.load(), _mm_set1_epi32(r))); }
REV_INLINE v3u REV_VECTORCALL operator/(v3u l, u32 r) { return v3u(_mm_div_epi32(l.load(), _mm_set1_epi32(r))); }
...
REV_INLINE v3u REV_VECTORCALL operator*(u32 l, v3u r) { return v3u(_mm_mul_epi32(_mm_set1_epi32(l), r.load())); }
REV_INLINE v3u REV_VECTORCALL operator/(u32 l, v3u r) { return v3u(_mm_div_epi32(_mm_set1_epi32(l), r.load())); }
...
REV_INLINE v3  REV_VECTORCALL v3u_to_v3 (v3u v) { return v3 (_mm_cvtepi32_ps(v.load())); }
...
union REV_INTRIN_TYPE v4s final
{
    ...
    REV_INLINE v4s& REV_VECTORCALL operator*=(v4s r) { mm = _mm_mul_epi32(mm, r.mm); return *this; }
    ...
    REV_INLINE v4s& REV_VECTORCALL operator*=(s32 r) { mm = _mm_mul_epi32(mm, _mm_set1_epi32(r)); return *this; }
...
REV_INLINE v4s REV_VECTORCALL operator*(v4s l, v4s r) { return v4s(_mm_mul_epi32(l.mm, r.mm)); }
...
REV_INLINE v4s REV_VECTORCALL operator*(v4s l, s32 r) { return v4s(_mm_mul_epi32(l.mm, _mm_set1_epi32(r))); }
...
REV_INLINE v4s REV_VECTORCALL operator*(s32 l, v4s r) { return v4s(_mm_mul_epi32(_mm_set1_epi32(l), r.mm)); }
...
union REV_INTRIN_TYPE v4u final
{
    ...
    REV_INLINE v4u& REV_VECTORCALL operator*=(v4u r) { mm = _mm_mul_epi32(mm, r.mm); return *this; }
    REV_INLINE v4u& REV_VECTORCALL operator/=(v4u r) { mm = _mm_div_epi32(mm, r.mm); return *this; }
    ...
    REV_INLINE v4u& REV_VECTORCALL operator*=(u32 r) { mm = _mm_mul_epi32(mm, _mm_set1_epi32(r)); return *this; }
    REV_INLINE v4u& REV_VECTORCALL operator/=(u32 r) { mm = _mm_div_epi32(mm, _mm_set1_epi32(r)); return *this; }
...
REV_INLINE v4u REV_VECTORCALL operator*(v4u l, v4u r) { return v4u(_mm_mul_epi32(l.mm, r.mm)); }
REV_INLINE v4u REV_VECTORCALL operator/(v4u l, v4u r) { return v4u(_mm_div_epi32(l.mm, r.mm)); }
...
REV_INLINE v4u REV_VECTORCALL operator*(v4u l, u32 r) { return v4u(_mm_mul_epi32(l.mm, _mm_set1_epi32(r))); }
REV_INLINE v4u REV_VECTORCALL operator/(v4u l, u32 r) { return v4u(_mm_div_epi32(l.mm, _mm_set1_epi32(r))); }
...
REV_INLINE v4u REV_VECTORCALL operator*(u32 l, v4u r) { return v4u(_mm_mul_epi32(_mm_set1_epi32(l), r.mm)); }
REV_INLINE v4u REV_VECTORCALL operator/(u32 l, v4u r) { return v4u(_mm_div_epi32(_mm_set1_epi32(l), r.mm)); }
...
REV_INLINE v4  REV_VECTORCALL v4u_to_v4 (v4u v) { return v4 (_mm_cvtepi32_ps(v.mm)); }
