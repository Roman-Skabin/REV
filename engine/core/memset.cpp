...
internal INLINE void memset_f32_avx512(f32 *mem, f32 val, u64 count)
{
...
internal INLINE void memset_f32_avx(f32 *mem, f32 val, u64 count)
{
...
#if ENGINE_ISA >= ENGINE_ISA_AVX512
internal INLINE void memset_f64_avx512(f64 *mem, f64 val, u64 count)
{
...
#elif ENGINE_ISA >= ENGINE_ISA_AVX
internal INLINE void memset_f64_avx(f64 *mem, f64 val, u64 count)
{
...
#if ENGINE_ISA >= ENGINE_ISA_AVX512
internal INLINE void memset_s8_avx512(s8 *mem, s8 val, u64 count)
{
    __m512i *mm512_mem = cast<__m512i *>(mem);
    __m512i  mm512_val = _mm512_set1_epi8(val);
...
#elif ENGINE_ISA >= ENGINE_ISA_AVX
internal INLINE void memset_s8_avx(s8 *mem, s8 val, u64 count)
{
    __m256i *mm256_mem = cast<__m256i *>(mem);
    __m256i  mm256_val = _mm256_set1_epi8(val);
...
#if ENGINE_ISA >= ENGINE_ISA_AVX512
internal INLINE void memset_s16_avx512(s16 *mem, s16 val, u64 count)
{
    __m512i *mm512_mem = cast<__m512i *>(mem);
...
#elif ENGINE_ISA >= ENGINE_ISA_AVX
internal INLINE void memset_s16_avx(s16 *mem, s16 val, u64 count)
{
    __m256i *mm256_mem = cast<__m256i *>(mem);
...
#if ENGINE_ISA >= ENGINE_ISA_AVX512
internal INLINE void memset_s32_avx512(s32 *mem, s32 val, u64 count)
{
    __m512i *mm512_mem = cast<__m512i *>(mem);
...
#elif ENGINE_ISA >= ENGINE_ISA_AVX
internal INLINE void memset_s32_avx(s32 *mem, s32 val, u64 count)
{
    __m256i *mm256_mem = cast<__m256i *>(mem);
...
#if ENGINE_ISA >= ENGINE_ISA_AVX512
internal INLINE void memset_s64_avx512(s64 *mem, s64 val, u64 count)
{
    __m512i *mm512_mem = cast<__m512i *>(mem);
...
#elif ENGINE_ISA >= ENGINE_ISA_AVX
internal INLINE void memset_s64_avx(s64 *mem, s64 val, u64 count)
{
    __m256i *mm256_mem = cast<__m256i *>(mem);
