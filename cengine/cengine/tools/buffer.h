...
CEXTERN void *CreateBuffer(Allocator *allocator, u64 alignment_in_bytes);
CEXTERN void  DestroyBuffer(void *buffer);

CEXTERN void *ExpandBuffer(BufferHeader *header, u64 element_bytes);
