...
union REV_INTRIN_TYPE REV_ALIGN(8) v2 final
{
    struct { f32 x, y; };
    struct { f32 w, h; };
...
REV_INLINE v2 __vectorcall operator+(v2 l, v2 r) { return v2(l.x + r.x, l.y + r.y); }
REV_INLINE v2 __vectorcall operator-(v2 l, v2 r) { return v2(l.x - r.x, l.y - r.y); }
REV_INLINE v2 __vectorcall operator*(v2 l, v2 r) { return v2(l.x * r.x, l.y * r.y); }
REV_INLINE v2 __vectorcall operator/(v2 l, v2 r) { return v2(l.x / r.x, l.y / r.y); }

REV_INLINE v2 __vectorcall operator+(v2 l, f32 r) { return v2(l.x + r, l.y + r); }
REV_INLINE v2 __vectorcall operator-(v2 l, f32 r) { return v2(l.x - r, l.y - r); }
REV_INLINE v2 __vectorcall operator*(v2 l, f32 r) { return v2(l.x * r, l.y * r); }
REV_INLINE v2 __vectorcall operator/(v2 l, f32 r) { return v2(l.x / r, l.y / r); }

REV_INLINE v2 __vectorcall operator+(f32 l, v2 r) { return v2(l + r.x, l + r.y); }
REV_INLINE v2 __vectorcall operator-(f32 l, v2 r) { return v2(l - r.x, l - r.y); }
REV_INLINE v2 __vectorcall operator*(f32 l, v2 r) { return v2(l * r.x, l * r.y); }
REV_INLINE v2 __vectorcall operator/(f32 l, v2 r) { return v2(l / r.x, l / r.y); }

REV_INLINE bool __vectorcall operator==(v2 l, v2 r) { return l.x == r.x && l.y == r.y; }
REV_INLINE bool __vectorcall operator!=(v2 l, v2 r) { return l.x != r.x || l.y != r.y; }
...
//      x1^2 + y1^2    <=>      x2^2 + y2^2
REV_INLINE bool __vectorcall operator<=(v2 l, v2 r) { return l.length_sq() <= r.length_sq(); }
REV_INLINE bool __vectorcall operator>=(v2 l, v2 r) { return l.length_sq() >= r.length_sq(); }
REV_INLINE bool __vectorcall operator< (v2 l, v2 r) { return l.length_sq() <  r.length_sq(); }
REV_INLINE bool __vectorcall operator> (v2 l, v2 r) { return l.length_sq() >  r.length_sq(); }

union REV_INTRIN_TYPE REV_ALIGN(8) v2s final
{
    struct { s32 x, y; };
    struct { s32 w, h; };
...
REV_INLINE v2s __vectorcall operator+(v2s l, v2s r) { return v2s(l.x + r.x, l.y + r.y); }
REV_INLINE v2s __vectorcall operator-(v2s l, v2s r) { return v2s(l.x - r.x, l.y - r.y); }
REV_INLINE v2s __vectorcall operator*(v2s l, v2s r) { return v2s(l.x * r.x, l.y * r.y); }
REV_INLINE v2s __vectorcall operator/(v2s l, v2s r) { return v2s(l.x / r.x, l.y / r.y); }

REV_INLINE v2s __vectorcall operator+(v2s l, s32 r) { return v2s(l.x + r, l.y + r); }
REV_INLINE v2s __vectorcall operator-(v2s l, s32 r) { return v2s(l.x - r, l.y - r); }
REV_INLINE v2s __vectorcall operator*(v2s l, s32 r) { return v2s(l.x * r, l.y * r); }
REV_INLINE v2s __vectorcall operator/(v2s l, s32 r) { return v2s(l.x / r, l.y / r); }

REV_INLINE v2s __vectorcall operator+(s32 l, v2s r) { return v2s(l + r.x, l + r.y); }
REV_INLINE v2s __vectorcall operator-(s32 l, v2s r) { return v2s(l - r.x, l - r.y); }
REV_INLINE v2s __vectorcall operator*(s32 l, v2s r) { return v2s(l * r.x, l * r.y); }
REV_INLINE v2s __vectorcall operator/(s32 l, v2s r) { return v2s(l / r.x, l / r.y); }

REV_INLINE bool __vectorcall operator==(v2s l, v2s r) { return l.x == r.x && l.y == r.y; }
REV_INLINE bool __vectorcall operator!=(v2s l, v2s r) { return l.x != r.x || l.y != r.y; }
...
// sqrt(x1^2 + y1^2)^2 <=> sqrt(x2^2 + y2^2)^2
//      x1^2 + y1^2    <=>      x2^2 + y2^2
REV_INLINE bool __vectorcall operator<=(v2s l, v2s r) { return l.length_sq() <= r.length_sq(); }
REV_INLINE bool __vectorcall operator>=(v2s l, v2s r) { return l.length_sq() >= r.length_sq(); }
REV_INLINE bool __vectorcall operator< (v2s l, v2s r) { return l.length_sq() <  r.length_sq(); }
REV_INLINE bool __vectorcall operator> (v2s l, v2s r) { return l.length_sq() >  r.length_sq(); }

union REV_INTRIN_TYPE REV_ALIGN(8) v2u final
{
    struct { u32 x, y; };
    struct { u32 w, h; };
    struct { u32 r, c; };
...
REV_INLINE v2u __vectorcall operator+(v2u l, v2u r) { return v2u(l.x + r.x, l.y + r.y); }
REV_INLINE v2u __vectorcall operator-(v2u l, v2u r) { return v2u(l.x - r.x, l.y - r.y); }
REV_INLINE v2u __vectorcall operator*(v2u l, v2u r) { return v2u(l.x * r.x, l.y * r.y); }
REV_INLINE v2u __vectorcall operator/(v2u l, v2u r) { return v2u(l.x / r.x, l.y / r.y); }

REV_INLINE v2u __vectorcall operator+(v2u l, u32 r) { return v2u(l.x + r, l.y + r); }
REV_INLINE v2u __vectorcall operator-(v2u l, u32 r) { return v2u(l.x - r, l.y - r); }
REV_INLINE v2u __vectorcall operator*(v2u l, u32 r) { return v2u(l.x * r, l.y * r); }
REV_INLINE v2u __vectorcall operator/(v2u l, u32 r) { return v2u(l.x / r, l.y / r); }

REV_INLINE v2u __vectorcall operator+(u32 l, v2u r) { return v2u(l + r.x, l + r.y); }
REV_INLINE v2u __vectorcall operator-(u32 l, v2u r) { return v2u(l - r.x, l - r.y); }
REV_INLINE v2u __vectorcall operator*(u32 l, v2u r) { return v2u(l * r.x, l * r.y); }
REV_INLINE v2u __vectorcall operator/(u32 l, v2u r) { return v2u(l / r.x, l / r.y); }

REV_INLINE bool __vectorcall operator==(v2u l, v2u r) { return l.x == r.x && l.y == r.y; }
REV_INLINE bool __vectorcall operator!=(v2u l, v2u r) { return l.x != r.x || l.y != r.y; }
...
// sqrt(x1^2 + y1^2)^2 <=> sqrt(x2^2 + y2^2)^2
//      x1^2 + y1^2    <=>      x2^2 + y2^2
REV_INLINE bool __vectorcall operator<=(v2u l, v2u r) { return l.length_sq() <= r.length_sq(); }
REV_INLINE bool __vectorcall operator>=(v2u l, v2u r) { return l.length_sq() >= r.length_sq(); }
REV_INLINE bool __vectorcall operator< (v2u l, v2u r) { return l.length_sq() <  r.length_sq(); }
REV_INLINE bool __vectorcall operator> (v2u l, v2u r) { return l.length_sq() >  r.length_sq(); }


REV_INLINE v2s __vectorcall v2_to_v2s (v2  v) { return v2s(cast<s32>(roundf(v.x)), cast<s32>(roundf(v.y))); }
REV_INLINE v2u __vectorcall v2_to_v2u (v2  v) { return v2u(cast<u32>(roundf(v.x)), cast<u32>(roundf(v.y))); }
REV_INLINE v2  __vectorcall v2s_to_v2 (v2s v) { return v2 (cast<f32>(       v.x ), cast<f32>(       v.y )); }
REV_INLINE v2u __vectorcall v2s_to_v2u(v2s v) { return v2u(cast<u32>(       v.x ), cast<u32>(       v.y )); }
REV_INLINE v2  __vectorcall v2u_to_v2 (v2u v) { return v2 (cast<f32>(       v.x ), cast<f32>(       v.y )); }
REV_INLINE v2s __vectorcall v2u_to_v2s(v2u v) { return v2s(cast<s32>(       v.x ), cast<s32>(       v.y )); }
...
union REV_INTRIN_TYPE v3 final
{
    ...
    f32  __vectorcall operator[](u8 i) const { REV_CHECK(i < 3); return e[i]; }
    f32& __vectorcall operator[](u8 i)       { REV_CHECK(i < 3); return e[i]; }
};

REV_INLINE v3 __vectorcall operator+(v3 l, v3 r) { return v3(_mm_add_ps(_mm_setr_ps(l.x, l.y, l.z, 0.0f), _mm_setr_ps(r.x, r.y, r.z, 0.0f))); }
REV_INLINE v3 __vectorcall operator-(v3 l, v3 r) { return v3(_mm_sub_ps(_mm_setr_ps(l.x, l.y, l.z, 0.0f), _mm_setr_ps(r.x, r.y, r.z, 0.0f))); }
REV_INLINE v3 __vectorcall operator*(v3 l, v3 r) { return v3(_mm_mul_ps(_mm_setr_ps(l.x, l.y, l.z, 0.0f), _mm_setr_ps(r.x, r.y, r.z, 0.0f))); }
REV_INLINE v3 __vectorcall operator/(v3 l, v3 r) { return v3(_mm_div_ps(_mm_setr_ps(l.x, l.y, l.z, 0.0f), _mm_setr_ps(r.x, r.y, r.z, 0.0f))); }

REV_INLINE v3 __vectorcall operator+(v3 l, f32 r) { return v3(_mm_add_ps(_mm_setr_ps(l.x, l.y, l.z, 0.0f), _mm_setr_ps(r, r, r, 0.0f))); }
REV_INLINE v3 __vectorcall operator-(v3 l, f32 r) { return v3(_mm_sub_ps(_mm_setr_ps(l.x, l.y, l.z, 0.0f), _mm_setr_ps(r, r, r, 0.0f))); }
REV_INLINE v3 __vectorcall operator*(v3 l, f32 r) { return v3(_mm_mul_ps(_mm_setr_ps(l.x, l.y, l.z, 0.0f), _mm_setr_ps(r, r, r, 0.0f))); }
REV_INLINE v3 __vectorcall operator/(v3 l, f32 r) { return v3(_mm_div_ps(_mm_setr_ps(l.x, l.y, l.z, 0.0f), _mm_setr_ps(r, r, r, 0.0f))); }

REV_INLINE v3 __vectorcall operator+(f32 l, v3 r) { return v3(_mm_add_ps(_mm_setr_ps(l, l, l, 0.0f), _mm_setr_ps(r.x, r.y, r.z, 0.0f))); }
REV_INLINE v3 __vectorcall operator-(f32 l, v3 r) { return v3(_mm_sub_ps(_mm_setr_ps(l, l, l, 0.0f), _mm_setr_ps(r.x, r.y, r.z, 0.0f))); }
REV_INLINE v3 __vectorcall operator*(f32 l, v3 r) { return v3(_mm_mul_ps(_mm_setr_ps(l, l, l, 0.0f), _mm_setr_ps(r.x, r.y, r.z, 0.0f))); }
REV_INLINE v3 __vectorcall operator/(f32 l, v3 r) { return v3(_mm_div_ps(_mm_setr_ps(l, l, l, 0.0f), _mm_setr_ps(r.x, r.y, r.z, 0.0f))); }

REV_INLINE bool __vectorcall operator==(v3 l, v3 r)
{
...
REV_INLINE bool __vectorcall operator<=(v3 l, v3 r) { return l.length_sq() <= r.length_sq(); }
REV_INLINE bool __vectorcall operator>=(v3 l, v3 r) { return l.length_sq() >= r.length_sq(); }
REV_INLINE bool __vectorcall operator< (v3 l, v3 r) { return l.length_sq() <  r.length_sq(); }
REV_INLINE bool __vectorcall operator> (v3 l, v3 r) { return l.length_sq() >  r.length_sq(); }
...
union REV_INTRIN_TYPE v3s final
{
    ...
    s32  __vectorcall operator[](u8 i) const { REV_CHECK(i < 3); return e[i]; }
    s32& __vectorcall operator[](u8 i)       { REV_CHECK(i < 3); return e[i]; }
};

REV_INLINE v3s __vectorcall operator+(v3s l, v3s r) { return v3s(_mm_add_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }
REV_INLINE v3s __vectorcall operator-(v3s l, v3s r) { return v3s(_mm_sub_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }
REV_INLINE v3s __vectorcall operator*(v3s l, v3s r) { return v3s(_mm_mul_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }
REV_INLINE v3s __vectorcall operator/(v3s l, v3s r) { return v3s(_mm_div_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }

REV_INLINE v3s __vectorcall operator+(v3s l, s32 r) { return v3s(_mm_add_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r, r, r, 0))); }
REV_INLINE v3s __vectorcall operator-(v3s l, s32 r) { return v3s(_mm_sub_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r, r, r, 0))); }
REV_INLINE v3s __vectorcall operator*(v3s l, s32 r) { return v3s(_mm_mul_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r, r, r, 0))); }
REV_INLINE v3s __vectorcall operator/(v3s l, s32 r) { return v3s(_mm_div_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r, r, r, 0))); }

REV_INLINE v3s __vectorcall operator+(s32 l, v3s r) { return v3s(_mm_add_epi32(_mm_setr_epi32(l, l, l, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }
REV_INLINE v3s __vectorcall operator-(s32 l, v3s r) { return v3s(_mm_sub_epi32(_mm_setr_epi32(l, l, l, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }
REV_INLINE v3s __vectorcall operator*(s32 l, v3s r) { return v3s(_mm_mul_epi32(_mm_setr_epi32(l, l, l, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }
REV_INLINE v3s __vectorcall operator/(s32 l, v3s r) { return v3s(_mm_div_epi32(_mm_setr_epi32(l, l, l, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }

REV_INLINE bool __vectorcall operator==(v3s l, v3s r)
{
...
// sqrt(x1^2 + y1^2 + z1^2)^2 <=> sqrt(x2^2 + y2^2 + z2^2)^2
//      x1^2 + y1^2 + z1^2    <=>      x2^2 + y2^2 + z2^2
REV_INLINE bool __vectorcall operator<=(v3s l, v3s r) { return l.length_sq() <= r.length_sq(); }
REV_INLINE bool __vectorcall operator>=(v3s l, v3s r) { return l.length_sq() >= r.length_sq(); }
REV_INLINE bool __vectorcall operator< (v3s l, v3s r) { return l.length_sq() <  r.length_sq(); }
REV_INLINE bool __vectorcall operator> (v3s l, v3s r) { return l.length_sq() >  r.length_sq(); }
...
union REV_INTRIN_TYPE v3u final
{
    ...
    u32  __vectorcall operator[](u8 i) const { REV_CHECK(i < 3); return e[i]; }
    u32& __vectorcall operator[](u8 i)       { REV_CHECK(i < 3); return e[i]; }
};

REV_INLINE v3u __vectorcall operator+(v3u l, v3u r) { return v3u(_mm_add_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }
REV_INLINE v3u __vectorcall operator-(v3u l, v3u r) { return v3u(_mm_sub_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }
REV_INLINE v3u __vectorcall operator*(v3u l, v3u r) { return v3u(_mm_mul_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }
REV_INLINE v3u __vectorcall operator/(v3u l, v3u r) { return v3u(_mm_div_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }

REV_INLINE v3u __vectorcall operator+(v3u l, u32 r) { return v3u(_mm_add_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r, r, r, 0))); }
REV_INLINE v3u __vectorcall operator-(v3u l, u32 r) { return v3u(_mm_sub_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r, r, r, 0))); }
REV_INLINE v3u __vectorcall operator*(v3u l, u32 r) { return v3u(_mm_mul_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r, r, r, 0))); }
REV_INLINE v3u __vectorcall operator/(v3u l, u32 r) { return v3u(_mm_div_epi32(_mm_setr_epi32(l.x, l.y, l.z, 0), _mm_setr_epi32(r, r, r, 0))); }

REV_INLINE v3u __vectorcall operator+(u32 l, v3u r) { return v3u(_mm_add_epi32(_mm_setr_epi32(l, l, l, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }
REV_INLINE v3u __vectorcall operator-(u32 l, v3u r) { return v3u(_mm_sub_epi32(_mm_setr_epi32(l, l, l, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }
REV_INLINE v3u __vectorcall operator*(u32 l, v3u r) { return v3u(_mm_mul_epi32(_mm_setr_epi32(l, l, l, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }
REV_INLINE v3u __vectorcall operator/(u32 l, v3u r) { return v3u(_mm_div_epi32(_mm_setr_epi32(l, l, l, 0), _mm_setr_epi32(r.x, r.y, r.z, 0))); }

REV_INLINE bool __vectorcall operator==(v3u l, v3u r)
{
    __m128i l_mm = _mm_setr_epi32(l.x, l.y, l.z, 0);
    __m128i r_mm = _mm_setr_epi32(r.x, r.y, r.z, 0);
#if REV_ISA >= REV_ISA_AVX512
...
// sqrt(x1^2 + y1^2 + z1^2)^2 <=> sqrt(x2^2 + y2^2 + z2^2)^2
//      x1^2 + y1^2 + z1^2    <=>      x2^2 + y2^2 + z2^2
REV_INLINE bool __vectorcall operator<=(v3u l, v3u r) { return l.length_sq() <= r.length_sq(); }
REV_INLINE bool __vectorcall operator>=(v3u l, v3u r) { return l.length_sq() >= r.length_sq(); }
REV_INLINE bool __vectorcall operator< (v3u l, v3u r) { return l.length_sq() <  r.length_sq(); }
REV_INLINE bool __vectorcall operator> (v3u l, v3u r) { return l.length_sq() >  r.length_sq(); }


REV_INLINE v3s __vectorcall v3_to_v3s (v3  v) { return v3s(_mm_cvtps_epi32(_mm_setr_ps   (v.x, v.y, v.z, 0.0f))); }
REV_INLINE v3u __vectorcall v3_to_v3u (v3  v) { return v3u(_mm_cvtps_epi32(_mm_setr_ps   (v.x, v.y, v.z, 0.0f))); }
REV_INLINE v3  __vectorcall v3s_to_v3 (v3s v) { return v3 (_mm_cvtepi32_ps(_mm_setr_epi32(v.x, v.y, v.z, 0   ))); }
REV_INLINE v3u __vectorcall v3s_to_v3u(v3s v) { return v3u(                _mm_setr_epi32(v.x, v.y, v.z, 0   ) ); }
REV_INLINE v3  __vectorcall v3u_to_v3 (v3u v) { return v3 (_mm_cvtepi32_ps(_mm_setr_epi32(v.x, v.y, v.z, 0   ))); }
REV_INLINE v3s __vectorcall v3u_to_v3s(v3u v) { return v3s(                _mm_setr_epi32(v.x, v.y, v.z, 0   ) ); }

//
// v4
//

union REV_INTRIN_TYPE REV_ALIGN(16) v4 final
{
    struct { f32 x,  y,  z, w; };
    struct { f32 r,  g,  b, a; };
    struct { v2  xy, wh; };
    ...
    f32  __vectorcall operator[](u8 i) const { REV_CHECK(i < 4); return mm.m128_f32[i]; }
    f32& __vectorcall operator[](u8 i)       { REV_CHECK(i < 4); return mm.m128_f32[i]; }
};

REV_INLINE v4 __vectorcall operator+(v4 l, v4 r) { return v4(_mm_add_ps(l.mm, r.mm)); }
REV_INLINE v4 __vectorcall operator-(v4 l, v4 r) { return v4(_mm_sub_ps(l.mm, r.mm)); }
REV_INLINE v4 __vectorcall operator*(v4 l, v4 r) { return v4(_mm_mul_ps(l.mm, r.mm)); }
REV_INLINE v4 __vectorcall operator/(v4 l, v4 r) { return v4(_mm_div_ps(l.mm, r.mm)); }

REV_INLINE v4 __vectorcall operator+(v4 l, f32 r) { return v4(_mm_add_ps(l.mm, _mm_set_ps1(r))); }
REV_INLINE v4 __vectorcall operator-(v4 l, f32 r) { return v4(_mm_sub_ps(l.mm, _mm_set_ps1(r))); }
REV_INLINE v4 __vectorcall operator*(v4 l, f32 r) { return v4(_mm_mul_ps(l.mm, _mm_set_ps1(r))); }
REV_INLINE v4 __vectorcall operator/(v4 l, f32 r) { return v4(_mm_div_ps(l.mm, _mm_set_ps1(r))); }

REV_INLINE v4 __vectorcall operator+(f32 l, v4 r) { return v4(_mm_add_ps(_mm_set_ps1(l), r.mm)); }
REV_INLINE v4 __vectorcall operator-(f32 l, v4 r) { return v4(_mm_sub_ps(_mm_set_ps1(l), r.mm)); }
REV_INLINE v4 __vectorcall operator*(f32 l, v4 r) { return v4(_mm_mul_ps(_mm_set_ps1(l), r.mm)); }
REV_INLINE v4 __vectorcall operator/(f32 l, v4 r) { return v4(_mm_div_ps(_mm_set_ps1(l), r.mm)); }

REV_INLINE bool __vectorcall operator==(v4 l, v4 r)
{
#if REV_ISA >= REV_ISA_AVX512
...
// sqrt(x1^2 + y1^2 + z1^2)^2 <=> sqrt(x2^2 + y2^2 + z2^2)^2
//      x1^2 + y1^2 + z1^2    <=>      x2^2 + y2^2 + z2^2
REV_INLINE bool __vectorcall operator<=(v4 l, v4 r) { return l.length_sq() <= r.length_sq(); }
REV_INLINE bool __vectorcall operator>=(v4 l, v4 r) { return l.length_sq() >= r.length_sq(); }
REV_INLINE bool __vectorcall operator< (v4 l, v4 r) { return l.length_sq() <  r.length_sq(); }
REV_INLINE bool __vectorcall operator> (v4 l, v4 r) { return l.length_sq() >  r.length_sq(); }

union REV_INTRIN_TYPE REV_ALIGN(16) v4s final
{
    struct { s32 x,  y,  z, w; };
    struct { s32 r,  g,  b, a; };
    struct { v2s xy, wh; };
    ...
    s32  __vectorcall operator[](u8 i) const { REV_CHECK(i < 4); return            mm.m128i_i32[i];  }
    s32& __vectorcall operator[](u8 i)       { REV_CHECK(i < 4); return cast<s32&>(mm.m128i_i32[i]); }
};

REV_INLINE v4s __vectorcall operator+(v4s l, v4s r) { return v4s(_mm_add_epi32(l.mm, r.mm)); }
REV_INLINE v4s __vectorcall operator-(v4s l, v4s r) { return v4s(_mm_sub_epi32(l.mm, r.mm)); }
REV_INLINE v4s __vectorcall operator*(v4s l, v4s r) { return v4s(_mm_mul_epi32(l.mm, r.mm)); }
REV_INLINE v4s __vectorcall operator/(v4s l, v4s r) { return v4s(_mm_div_epi32(l.mm, r.mm)); }

REV_INLINE v4s __vectorcall operator+(v4s l, s32 r) { return v4s(_mm_add_epi32(l.mm, _mm_set1_epi32(r))); }
REV_INLINE v4s __vectorcall operator-(v4s l, s32 r) { return v4s(_mm_sub_epi32(l.mm, _mm_set1_epi32(r))); }
REV_INLINE v4s __vectorcall operator*(v4s l, s32 r) { return v4s(_mm_mul_epi32(l.mm, _mm_set1_epi32(r))); }
REV_INLINE v4s __vectorcall operator/(v4s l, s32 r) { return v4s(_mm_div_epi32(l.mm, _mm_set1_epi32(r))); }

REV_INLINE v4s __vectorcall operator+(s32 l, v4s r) { return v4s(_mm_add_epi32(_mm_set1_epi32(l), r.mm)); }
REV_INLINE v4s __vectorcall operator-(s32 l, v4s r) { return v4s(_mm_sub_epi32(_mm_set1_epi32(l), r.mm)); }
REV_INLINE v4s __vectorcall operator*(s32 l, v4s r) { return v4s(_mm_mul_epi32(_mm_set1_epi32(l), r.mm)); }
REV_INLINE v4s __vectorcall operator/(s32 l, v4s r) { return v4s(_mm_div_epi32(_mm_set1_epi32(l), r.mm)); }

REV_INLINE bool __vectorcall operator==(v4s l, v4s r)
{
#if REV_ISA >= REV_ISA_AVX512
...
// sqrt(x1^2 + y1^2 + z1^2)^2 <=> sqrt(x2^2 + y2^2 + z2^2)^2
//      x1^2 + y1^2 + z1^2    <=>      x2^2 + y2^2 + z2^2
REV_INLINE bool __vectorcall operator<=(v4s l, v4s r) { return l.length_sq() <= r.length_sq(); }
REV_INLINE bool __vectorcall operator>=(v4s l, v4s r) { return l.length_sq() >= r.length_sq(); }
REV_INLINE bool __vectorcall operator< (v4s l, v4s r) { return l.length_sq() <  r.length_sq(); }
REV_INLINE bool __vectorcall operator> (v4s l, v4s r) { return l.length_sq() >  r.length_sq(); }

union REV_INTRIN_TYPE REV_ALIGN(16) v4u final
{
    struct { u32 x,  y,  z, w; };
    struct { u32 r,  g,  b, a; };
    struct { v2u xy, wh; };
    ...
    u32  __vectorcall operator[](u8 i) const { REV_CHECK(i < 4); return cast<u32 >(mm.m128i_i32[i]); }
    u32& __vectorcall operator[](u8 i)       { REV_CHECK(i < 4); return cast<u32&>(mm.m128i_i32[i]); }
};

REV_INLINE v4u __vectorcall operator+(v4u l, v4u r) { return v4u(_mm_add_epi32(l.mm, r.mm)); }
REV_INLINE v4u __vectorcall operator-(v4u l, v4u r) { return v4u(_mm_sub_epi32(l.mm, r.mm)); }
REV_INLINE v4u __vectorcall operator*(v4u l, v4u r) { return v4u(_mm_mul_epi32(l.mm, r.mm)); }
REV_INLINE v4u __vectorcall operator/(v4u l, v4u r) { return v4u(_mm_div_epi32(l.mm, r.mm)); }

REV_INLINE v4u __vectorcall operator+(v4u l, u32 r) { return v4u(_mm_add_epi32(l.mm, _mm_set1_epi32(r))); }
REV_INLINE v4u __vectorcall operator-(v4u l, u32 r) { return v4u(_mm_sub_epi32(l.mm, _mm_set1_epi32(r))); }
REV_INLINE v4u __vectorcall operator*(v4u l, u32 r) { return v4u(_mm_mul_epi32(l.mm, _mm_set1_epi32(r))); }
REV_INLINE v4u __vectorcall operator/(v4u l, u32 r) { return v4u(_mm_div_epi32(l.mm, _mm_set1_epi32(r))); }

REV_INLINE v4u __vectorcall operator+(u32 l, v4u r) { return v4u(_mm_add_epi32(_mm_set1_epi32(l), r.mm)); }
REV_INLINE v4u __vectorcall operator-(u32 l, v4u r) { return v4u(_mm_sub_epi32(_mm_set1_epi32(l), r.mm)); }
REV_INLINE v4u __vectorcall operator*(u32 l, v4u r) { return v4u(_mm_mul_epi32(_mm_set1_epi32(l), r.mm)); }
REV_INLINE v4u __vectorcall operator/(u32 l, v4u r) { return v4u(_mm_div_epi32(_mm_set1_epi32(l), r.mm)); }

REV_INLINE bool __vectorcall operator==(v4u l, v4u r)
{
#if REV_ISA >= REV_ISA_AVX512
    return 0b11 == _mm_cmpeq_epi64_mask(l.mm, r.mm);
#else
...
// sqrt(x1^2 + y1^2 + z1^2)^2 <=> sqrt(x2^2 + y2^2 + z2^2)^2
//      x1^2 + y1^2 + z1^2    <=>      x2^2 + y2^2 + z2^2
REV_INLINE bool __vectorcall operator<=(v4u l, v4u r) { return l.length_sq() <= r.length_sq(); }
REV_INLINE bool __vectorcall operator>=(v4u l, v4u r) { return l.length_sq() >= r.length_sq(); }
REV_INLINE bool __vectorcall operator< (v4u l, v4u r) { return l.length_sq() <  r.length_sq(); }
REV_INLINE bool __vectorcall operator> (v4u l, v4u r) { return l.length_sq() >  r.length_sq(); }


REV_INLINE v4s __vectorcall v4_to_v4s (v4  v) { return v4s(_mm_cvtps_epi32(v.mm)); }
REV_INLINE v4u __vectorcall v4_to_v4u (v4  v) { return v4u(_mm_cvtps_epi32(v.mm)); }
REV_INLINE v4  __vectorcall v4s_to_v4 (v4s v) { return v4 (_mm_cvtepi32_ps(v.mm)); }
REV_INLINE v4u __vectorcall v4s_to_v4u(v4s v) { return v4u(                v.mm ); }
REV_INLINE v4  __vectorcall v4u_to_v4 (v4u v) { return v4 (_mm_cvtepi32_ps(v.mm)); }
REV_INLINE v4s __vectorcall v4u_to_v4s(v4u v) { return v4s(                v.mm ); }
