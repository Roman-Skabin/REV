...
namespace REV::Math
{
    ...
    union REV_INTRIN_TYPE REV_ALIGN(4) reg32 final
    {
        f32 f;
        s32 s;
        u32 u;
    ...
    union REV_INTRIN_TYPE REV_ALIGN(8) reg64 final
    {
        f64 f;
        s64 s;
        u64 u;
    ...
    REV_INLINE T __vectorcall lerp(T start, T end, T percent)
    {
    ...
    REV_INLINE T __vectorcall clamp(T val, T min_val, T max_val)
    {
