...
namespace REV
{
    ...
    public:
        ...
        REV_INLINE const Scene               *GetCurrentScene()        const { return m_CurrentScene;        }
        ...
        REV_INLINE const ForwardPlusPipeline& GetForwardPlusPipeline() const { return m_ForwardPlusPipeline; }
        ...
        REV_INLINE Scene               *GetCurrentScene()        { return m_CurrentScene;        }
