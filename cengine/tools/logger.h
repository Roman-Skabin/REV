...
CENGINE_FUN void         CreateLogger(Logger *logger, const char *name, const char *filename, LOG_TO log_to);
CENGINE_FUN void         DestroyLogger(Logger *logger);
CENGINE_FUN void __cdecl LoggerLog(Logger *logger, const char *format, ...);
